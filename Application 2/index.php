                ...
                <div class="nav1" style="width: 40%; height: 100%; background-color: #87CEFA; padding: 0px; margin: 0% 0% 0% 30%;">
                    ...
                    <p style="font-size: 35px; text-align: center; margin-top: 0%; padding-top: 2%;"><strong>SONATEL ACADÉMIE</strong></p>
                        ...
                        <div class="nav4a" style="float: left; width: 100%; height: 10%; margin: 3% 0% 0% 0%;">
                            <p style="color: white; margin: 0px 0% 0% 45% ;">Select C3</p>
                            <img src="images/2-3.png" style="float: left; width: 5%; background-color: green; margin: 1% 0% 0% 22%; border-radius: 8px 8px 8px 8px;">
                            <select name="choixc3" style="position: absolute; width:20%; height: 4%; margin: 0.5% 0% 0% 0%; border-radius: 7px 7px 7px 7px;">
                                <?php 
                                    foreach($color as $key=>$value){?>
                                    <option value="<?php echo"$value"; ?>"><?php echo"$key" ?></option>
                                <?php
                        ...
                        <div class="nav5a" style="float: left; width: 100%; height: 10%; margin: 3% 0% 0% 0%;">
                        ...
                        <div class="nav6a" style="float: left; width: 100%; height: 15%; margin: 3% 0% 3% 0%;">
...
<!-- PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP PARTIE PHP -->
...
<?php
    ...
    $choixc1= $_POST['choixc1'];
    $choixc2= $_POST['choixc2'];
    $choixc3= $_POST['choixc3'];
    $choixp= $_POST['choixp'];
        if (!empty($_POST['taille'])){
            ...
            if ($choixc1==$choixc2 || $choixc1==$choixc3 || $choixc2==$choixc3){
            ...
            if ($choixp=="up"){
                echo '<table style="width: 50%; margin-top: 10%; margin-left: 25%;">';
                    for ($i=0; $i<$taille; $i++){
                        ...
                        for ($j=0; $j<$taille; $j++){
                            if (($i>$j && $i+$j<$taille-1) || ($i<$j && $i+$j>=$taille)){
                                echo "<td style='background-color: $choixc1; width: 25px; height: 25px;'>";
                                echo "</td>";
                            }
                            else
                            if ($i>$j && $i+$j>=$taille){
                                echo "<td style='background-color: $choixc3; width: 25px; height: 25px;'>";
                                echo "</td>";
                            }
                            else{
                                echo "<td style='background-color: $choixc2; width: 25px; height: 25px;'>";
                                echo "</td>";
                            }
